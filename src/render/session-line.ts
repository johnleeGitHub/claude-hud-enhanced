...
export function renderSessionLine(ctx: RenderContext): string {
  ...
  // Speed moved to identity line (context bar)
...
function formatContextValue(ctx: RenderContext, percent: number, mode: 'percent' | 'tokens' | 'remaining' | 'both' | 'percentTokens'): string {
