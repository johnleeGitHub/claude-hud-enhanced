 ...
 * 4. Default 200K
 */
export function getEffectiveContextWindow(stdin: StdinData, autoCompactWindow?: number | null): number {
  // 1. Explicit config
...
export function isThirdPartyModelId(modelId?: string): boolean {
  if (!modelId) {
    return false;
  }
