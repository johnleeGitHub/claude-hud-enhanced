...
let _omcDetected: boolean | null = null;
 ...
 */
export function resetOmcDetection(): void {
  _omcDetected = null;
}
...
export const DISPLAY_DENSITY_LEVELS: DensityConfig[] = [
  {
    density: 'minimal',
    maxWidth: 80,
 ...
 */
export function getDisplayDensity(columns: number | null): DisplayDensity {
...
export function isElementVisible(
  ...
  if (config.visibleElements.includes('*')) return true;
 ...
 */
export function getTheme(themeName: string | null | undefined): ColorTheme {
  if (!themeName) {
 ...
 */
export function listThemes(): ColorTheme[] {
  return COLOR_THEMES;
}
...
export function setCurrentModel(modelId: string | null): { current: string | null; previous: string | null; switched: boolean } {
